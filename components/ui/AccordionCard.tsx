...
import { AuditItemResult } from '@/types/audit';
...
export function AccordionCard({ itemResult, remainingYears }: AccordionCardProps) {
        ...
        <div className="text-right flex items-center gap-2 flex-shrink-0">
          <div>
            <p className="text-red-400 font-mono text-lg font-bold">
              ¥{Math.round(itemResult.financialLoss).toLocaleString()}
            </p>
            <p className="text-xs text-gray-500">/ {remainingYears}年間</p>
          </div>
          <svg
          ...
          >
            <div className="px-4 pb-4 text-sm text-gray-300 space-y-4 border-t border-gray-700 pt-4">
              ...
              <div className="flex items-start gap-2">
                <span className="text-gray-400 font-bold whitespace-nowrap">回答:</span>
              ...
              <div className="bg-gradient-to-br from-[#1a1a2e] to-[#16213e] rounded-lg p-4 space-y-3 border border-gray-700">
                ...
                {/* 計算式 - コードブロック風 */}
                <div>
                  <p className="text-xs text-gray-500 mb-2 uppercase tracking-wide">計算式</p>
                ...
                {/* 係数の説明 */}
                <div>
                  <p className="text-xs text-gray-500 mb-2 uppercase tracking-wide">なぜこの係数か</p>
                ...
                <div className="pt-2 border-t border-gray-700">
                  <div className="flex justify-between items-center">
                    <span className="text-gray-400 text-xs">生涯損失額</span>
              ...
              <div className="bg-yellow-900/20 border-l-4 border-yellow-500 rounded-r-lg p-3">
                <h4 className="font-bold text-yellow-400 text-sm mb-1">推奨アクション</h4>
