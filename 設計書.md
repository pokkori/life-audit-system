# 生涯損失監査システム (Life Audit System) 設計書 v2.2.0

## 1. システム概要

### 1.1 プロジェクト名
**Life Audit System（人生の監査システム）**
...
```typescript
type DisplayCategory = '資産監査' | '健康監査' | 'キャリア監査' | '時間・環境監査';
```
...
- **資産監査**: 投資、貯蓄、節約に関する質問。
- **健康監査**: 身体的・精神的健康に関する質問。
- **キャリア監査**: スキルアップ、転職、自己投資に関する質問。
- **時間・環境監査**: 時間管理、生活環境の最適化に関する質問。
